<template>
	<view class="u-padding-20">
		<u-form :model="form" ref="uForm" label-width="auto">
			...
			<u-form-item label="商品发布数量" prop="goodsLimit"><u-input v-model="form.goodsLimit" type="number" maxlength="6" /></u-form-item>
			...
			<u-form-item label="开始时间" prop="issueStartDate">
				<u-input v-model="form.issueStartDate" placeholder="请选择推广开始时间" type="select" @click="startShow = true" />
				<u-picker
					mode="time"
					v-model="startShow"
					:params="dateParams"
			...
			<u-form-item label="截止时间" prop="issueEndDate">
				<u-input v-model="form.issueEndDate" placeholder="请选择推广截止时间" type="select" @click="endShow = true" />
				<u-picker
					mode="time"
					v-model="endShow"
					:params="dateParams"
