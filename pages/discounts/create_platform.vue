<template>
	<view class="u-padding-20">
		<u-form :model="form" ref="uForm" label-width="auto">
			...
			<u-form-item label="商品产品类型" prop="platformCouponType">
				<u-input v-model="typeList[form.platformCouponType].text" type="select" @click="typeShow = true" placeholder="请选择商品产品类型" />
			...
			<u-form-item label="份数" prop="pcNum"><u-input v-model="form.pcNum" type="number" maxlength="6" placeholder="份数" /></u-form-item>
