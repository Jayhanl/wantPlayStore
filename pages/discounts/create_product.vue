	...
	<view class="u-padding-20">
		<u-form :model="form" ref="uForm" label-width="auto">
			...
			<u-form-item label="开始时间" prop="crUseStartDate">
				...
				<u-picker mode="time" v-model="startShow" :params="dateParams" title="开始时间" @confirm="e => (form.crUseStartDate = e.year + '-' + e.month + '-' + e.day+ ' ' +e.hour + ':' + e.minute)"></u-picker>
			</u-form-item>
			<u-form-item label="截止时间" prop="crUseEndDate">
				...
				<u-picker mode="time" v-model="endShow" :params="dateParams" title="截止日期" @confirm="e => (form.crUseEndDate = e.year + '-' + e.month + '-' + e.day+ ' ' +e.hour + ':' + e.minute)"></u-picker>
			</u-form-item>
		</u-form>
